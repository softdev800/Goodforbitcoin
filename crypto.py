...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # We have our own code to handle dragless moving.
        ...
        self.list_view.setFixedSize(226, 400)
        self.setFixedSize(650, 400)

        toolbar = QToolBar("Main")
        self.addToolBar(toolbar)
        self.currency_list = QComboBox()

        toolbar.addWidget(self.currency_list)
        self.update_currency_list(AVAILABLE_BASE_CURRENCIES)
        self.currency_list.setCurrentText(self.base_currency)
        self.currency_list.currentTextChanged.connect(self.change_base_currency)
        ...
        self.setWindowIcon(QIcon('resources/bitcoin-icon.png'))
        self.show()

    def update_currency_list(self, currencies):
        for currency in currencies:
            self.currency_list.addItem(currency)
        self.currency_list.model().sort(0)
